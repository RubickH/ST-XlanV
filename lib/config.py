...
__C.DATA_LOADER.TRAIN_S3D_FEATS = ''

__C.DATA_LOADER.TRAIN_S3D_LOGITS = ''

__C.DATA_LOADER.TRAIN_RES152_FEATS = 'up_down_10_100'

__C.DATA_LOADER.TRAIN_RES152_LOGITS = ''

__C.DATA_LOADER.VAL_S3D_FEATS = ''

__C.DATA_LOADER.VAL_S3D_LOGITS = ''

__C.DATA_LOADER.VAL_RES152_FEATS = 'up_down_10_100'

__C.DATA_LOADER.VAL_RES152_LOGITS = ''

__C.DATA_LOADER.TEST_S3D_FEATS = ''

__C.DATA_LOADER.TEST_S3D_LOGITS = ''

__C.DATA_LOADER.TEST_RES152_FEATS = 'up_down_10_100'

__C.DATA_LOADER.TEST_RES152_LOGITS = ''
...
__C.MODEL.TYPE = 'XLAN_VLP'               # 'UpDown', 'XLAN', 'XTransformer'

__C.MODEL.SEQ_LEN = 20                  # include <EOS>/<BOS>

__C.MODEL.VOCAB_SIZE = 12978           # exclude <EOS>/<BOS>

__C.MODEL.WORD_EMBED_DIM = 1024
...
__C.MODEL.S3D_FEATS_DIM = 1024

__C.MODEL.S3D_FEATS_EMBED_DIM = -1

__C.MODEL.S3D_FEATS_EMBED_ACT = 'NONE'     # 'RELU', 'CELU', 'NONE'

__C.MODEL.DROPOUT_S3D_EMBED = 0.0

__C.MODEL.S3D_FEATS_NORM = False

__C.MODEL.RES152_FEATS_DIM = 1024

__C.MODEL.RES152_FEATS_EMBED_DIM = -1

__C.MODEL.RES152_FEATS_EMBED_ACT = 'NONE'   # 'RELU', 'CELU', 'NONE'

__C.MODEL.DROPOUT_RES152_EMBED = 0.0

__C.MODEL.RES152_FEATS_NORM = False
...
__C.MODEL.BILINEAR.ENCODE_RES152_MID_DIM = [1]

__C.MODEL.BILINEAR.DECODE_RES152_MID_DIM = [1]

__C.MODEL.BILINEAR.ENCODE_RES152_MID_DROPOUT = 0.0

__C.MODEL.BILINEAR.DECODE_RES152_MID_DROPOUT = 0.0
...
__C.MODEL.IF_POS = False

__C.MODEL.IF_TAG = False
# ---------------------------------------------------------------------------- #
# Solver options
# ---------------------------------------------------------------------------- #
__C.SOLVER = edict()
...
__C.PARAM.ALIGNED_ACT = 'ALIGNED_ACT'

__C.PARAM.ALIGNED_CON = 'ALIGNED_CON'

__C.PARAM.WT = 'WT'

__C.PARAM.TAG_FEATS = 'TAG_FEATS'

__C.PARAM.TAG_FEATS_MASK = 'TAG_FEATS_MASK'

__C.PARAM.P_TAG_FEATS = 'P_TAG_FEATS'

__C.PARAM.GLOBAL_FEAT_TAG = 'GV_FEAT_TAG'


__C.PARAM.CROSS_FEATS = 'CROSS_FEATS'

__C.PARAM.CROSS_FEATS_MASK = 'CROSS_FEATS_MASK'

__C.PARAM.P_CROSS_FEATS = 'P_CROSS_FEATS'

__C.PARAM.GLOBAL_FEAT_CROSS = 'GV_FEAT_CROSS'


__C.PARAM.S3D_FEATS = 'S3D_FEATS'

__C.PARAM.S3D_FEATS_MASK = 'S3D_FEATS_MASK'

__C.PARAM.P_S3D_FEATS = 'P_S3D_FEATS'

__C.PARAM.GLOBAL_FEAT_S3D = 'GV_FEAT_S3D'

__C.PARAM.GLOBAL_FEAT = 'GV_FEAT'

__C.PARAM.RES152_FEATS = 'RES152_FEATS'

__C.PARAM.RES152_FEATS_MASK = 'RES152_FEATS_MASK'

__C.PARAM.P_RES152_FEATS = 'P_RES152_FEATS'

__C.PARAM.STATE = 'STATE'

__C.PARAM.INPUT_IDS = 'INPUT_IDS'

__C.PARAM.TAG_IDS = 'TAG_IDS'

__C.PARAM.TAG_MASK = 'TAG_MASK'

__C.PARAM.INPUT_MASK_ALL = 'INPUT_MASK_ALL'

__C.PARAM.TOKEN_LABELS_ALL = 'TOKEN_LABELS_ALL'
...
__C.INFERENCE.VOCAB = 'vlp_vocab.txt'
...
__C.INFERENCE.VAL_ANNFILE = 'vlp_val2k.json'
